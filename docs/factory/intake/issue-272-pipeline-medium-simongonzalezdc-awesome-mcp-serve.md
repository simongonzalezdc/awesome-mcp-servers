        # Factory intake for issue #272: [pipeline][MEDIUM] [simongonzalezdc/awesome-mcp-servers] Dashboard cannot fully read repository status

        Repository: `simongonzalezdc/awesome-mcp-servers`
        Category: `llm_fix`
        Source issue: `#272`
...
### Signal
- **Repo:** `simongonzalezdc/awesome-mcp-servers`
- **Kind:** `dashboard_repo_error`
- **Severity:** `MEDIUM`
- **Source:** `repos/status`
- **Fingerprint:** `issue-surfacing:601d6ca20426b51860ba`
...
```json
{
  "dashboard_row": {
    ...
    "ci_name": "Check Glama Link",
    "ci_status": "completed",
    "ci_timestamp": "2026-05-10T02:02:22Z",
    "errors": [
    ...
    "recent_commits": [
      {
        "date": "2026-05-10T02:02:19Z",
        "message": "Add agent-law workflow and supporting files (#1)",
        "sha": "398c414"
      },
      {
        "date": "2026-05-05T15:31:06Z",
        "message": "Add FUNDING.yml \u2014 support via GitHub Sponsors & Ko-fi",
        "sha": "0adc412"
      },
      {
        "date": "2026-03-19T21:54:44Z",
        "message": "Merge pull request #3515 from Winify/add-wdio-mcp-server",
        "sha": "b42f59a"
      },
      {
        "date": "2026-03-19T21:54:33Z",
        "message": "Fix formatting and update webdriverio/mcp entry",
        "sha": "bdbe056"
      },
      {
        "date": "2026-03-19T21:54:11Z",
...
<!-- issue-surfacing:601d6ca20426b51860ba -->

### Fallback routing
Target repository issue creation failed, so this finding was written to `simongonzalezdc/the-factory` instead of `simongonzalezdc/awesome-mcp-servers`.
